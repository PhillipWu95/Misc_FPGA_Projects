...
HD_PWD='C:/Users/Phillip/Documents/VIVADO/Misc_FPGA_Projects/hardware_FIFO/VIVADO/VIVADO.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FIFO4_8.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FIFO4_8.tcl -notrace
