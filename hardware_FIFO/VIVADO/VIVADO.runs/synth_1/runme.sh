...
HD_PWD='C:/Users/Phillip/Documents/VIVADO/Misc_FPGA_Projects/hardware_FIFO/VIVADO/VIVADO.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FIFO4_8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FIFO4_8.tcl
